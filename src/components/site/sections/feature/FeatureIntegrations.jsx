        ...
        <div className="flex flex-col items-center gap-[30px] min-[810px]:gap-10 min-[1200px]:gap-[50px]">
          ...
          >
            {integrations.items.map((item) => (
              <RevealItem key={item.name} className="flex flex-col items-center gap-5">
                <span className="grid size-[50px] shrink-0 place-items-center rounded-full bg-white">
                  <Mark src={item.icon} color={item.color} className="size-6" />
                </span>
