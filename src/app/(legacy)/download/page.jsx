...
function PlatformCard({ platform }) {
  ...
  return (
    <div
      className={`${styles.card} ${available ? "" : styles.cardDisabled}`.trim()}
    >
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.notice}>
        <strong>Already installed?</strong> Open the desktop app and sign in
        with the same email and password — your subscription and account sync
