...
// Used by the signup form so users from any country can enter a phone number.
...
export const COUNTRY_BY_ISO = COUNTRIES.reduce((acc, c) => {
  acc[c.iso] = c;
  return acc;
}, {});

// Select-ready items, e.g. { value: "IN", label: "India (+91)" }.
...
/**
 * Best-effort default country from the browser locale (e.g. "en-IN" -> "IN").
 * Falls back to "IN" if the region can't be determined or isn't in our list.
 */
